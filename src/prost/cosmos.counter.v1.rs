...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn increase_count(
            ...
            tonic::Response<super::MsgIncreaseCountResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod msg_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/cosmos.counter.v1.Msg/IncreaseCount" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgIncreaseCounter>
                    for IncreaseCountSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Msg>::increase_count(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "cosmos.counter.v1.Msg";
