            ...
            match req.uri().path() {
                "/cosmos.base.reflection.v1beta1.ReflectionService/ListAllInterfaces" => {
                    ...
                    > for ListAllInterfacesSvc<T> {
                        type Response = ::cosmos_sdk_proto::cosmos::base::reflection::v1beta1::ListAllInterfacesResponse;
                ...
                "/cosmos.base.reflection.v1beta1.ReflectionService/ListImplementations" => {
                    ...
                    > for ListImplementationsSvc<T> {
                        type Response = ::cosmos_sdk_proto::cosmos::base::reflection::v1beta1::ListImplementationsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
